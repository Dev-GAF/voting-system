      ...
      <div className="w-full max-w-md p-8 bg-white rounded-lg shadow-md">
        ...
        <form action={registerUser} className="space-y-4">
          ...
          <div>
              ...
              <input type="password" id="confirmPassword" name="confirmPassword" className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"/>
          </div>
        ...
        <div className="flex justify-center items-center mt-6">
          <span className="text-sm text-gray-600">Já tem uma conta? <Link href="/login" className="text-blue-500 hover:underline">Entrar</Link></span>
        </div>
